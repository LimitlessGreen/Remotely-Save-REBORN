...
export class OneDriveApiClient {
  ...
  public async upload(drivePath: string, content: ArrayBuffer): Promise<OneDriveItem> {
  ...
  public async createFolder(parentDrivePath: string, name: string): Promise<OneDriveItem> {
